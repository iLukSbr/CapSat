...
#define COMPONENTS_VECTOR_SIZE ACCELEROMETER+ALTIMETER+ESP32_CAMERA+GAS_METER+GPS+HUMIDIMETER+MAGNETOMETER+MULTIMETER+OZONOSCOPE+PARTICULATE_METER+RAINMETER+RTCLOCK